        ...
        <View className="flex-1 w-full justify-center items-center">
            ...
            className="flex-1 w-screen pt-10">
                ...
                <View className="w-full">
                    <TouchableOpacity onPress={() => route.navigate('/auth/signup')} className="bg-white w-[75%] mx-auto py-4 rounded-2xl mt-1"><Text className="text-black text-lg text-center font-semibold">Sign up with mail</Text></TouchableOpacity>
